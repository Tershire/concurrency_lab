...
use_mutex == true : count is not correct and random
use_mutex == false: count is correct
why (?)
*/
...
void counter(const int& N, int& count, bool& use_mutex, std::mutex& mutex)
{
    for (int i = 0; count < N; ++i)
    {
        ...
        /* should return the key (unlock).
        otherwise, all the threads including myself cannot enter (lock).
        */
    }
}
